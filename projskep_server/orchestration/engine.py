...
from projskep_server.services.event_bus import event_bus
from projskep_server.schemas.events import SystemEvent, TracePayload, WorkflowPayload, MetricPayload
...
class OrchestrationEngine:
    ...
    async def run_workflow(self, name: str, category: str):
        ...
        self.active_workflows[workflow_id] = {"name": name, "status": "RUNNING", "progress": 0}
        ...
        steps = ["Context Retrieval", "Semantic Validation", "Drift Detection", "Proposal Generation"]
