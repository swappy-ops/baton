from projskep.agents.nodes import get_model
...
class WorkflowEngine:
    def __init__(self):
        self.workflows = {
            ...
            "ux_critique": "Critique the interface based on ProjSkep's cinematic and instrument-like philosophy. Detect SaaS-style drift.",
